...
class LoginWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.batch_import_btn.clicked.connect(self.batch_ultra_fast_import)
        self.batch_import_btn.setStyleSheet("QPushButton { padding: 8px; background-color: #2196F3; color: white; }")
